(function () {
  ...
  var translations = {
    en: {
      ...
      'contact.lead': 'Write on Telegram or WhatsApp, or leave a message below.',
      'form.name': 'Name',
    ...
    ru: {
      ...
      'contact.lead': 'Напишите в Telegram или WhatsApp, либо оставьте сообщение ниже.',
      'form.name': 'Имя',
      'form.contact': 'Email / Telegram',
    ...
    de: {
      ...
      'contact.lead': 'Schreiben Sie auf Telegram oder WhatsApp, oder hinterlassen Sie unten eine Nachricht.',
      'form.name': 'Name',
